...
const EN: Dict = {
  ...
  "view.expenses": "Expenses tracking",
  ...
  "common.edit": "Edit",
  "fin.title": "Finances",
  "fin.householdIncome": "Household income",
  "fin.householdSavings": "Household savings",
  "fin.combined": "Combined",
  "fin.salariesFor": "Salaries for",
  "fin.savings": "Savings",
  "fin.deposit": "Deposit",
  "fin.withdraw": "Withdraw",
  "fin.forPerson": "For",
  "fin.labelPlaceholder": "Label (e.g. bonus, transfer)",
  "fin.notePlaceholder": "Note (optional)",
  "fin.recent": "Recent activity",
  "fin.noSavings": "No savings entries yet.",
  "fin.noIncome": "No income recorded yet.",
  "fin.incomeHistory": "Income history",
  "fin.investments": "Investments & savings",
  "fin.investmentValue": "Current value",
  "fin.investmentLabel": "Account / position (e.g. ETF, savings)",
  "fin.updateValue": "Save value",
  "fin.investmentHistory": "Value over time",
  "fin.noInvestments": "No investment values yet. Add one to start tracking.",
  "fin.latestValues": "Latest values",
  "fin.investmentHint": "Each save keeps history so you can see a chart over time.",
  ...
  "csv.bad": "Row {n}: {err}",
  "csv.sample": "Download sample CSV",
  "csv.titleSavings": "Import savings CSV",
  "csv.helpSavings": "Columns: Amount, Date, Label (negative amount = withdrawal)",
  "csv.importedSavings": "Imported {n} entries",
 "csv.titleInvestments": "Import investments CSV",
 "csv.helpInvestments": "Columns: Value, Date, Label",
 "csv.importedInvestments": "Imported {n} snapshots",
  ...
  "cats.budgets": "Category budgets",
  "cats.custom": "Custom categories",
  "lang.label": "Language",
...
const PL: Dict = {
  ...
  "view.switch": "Zmień widok",
  "view.expenses": "Śledzenie wydatków",
  "view.finances": "Finanse",
  ...
  "common.edit": "Edytuj",
  "fin.title": "Finanse",
  "fin.householdIncome": "Dochód domu",
  "fin.householdSavings": "Oszczędności domu",
  "fin.combined": "Razem",
  "fin.salariesFor": "Wynagrodzenia za",
  "fin.savings": "Oszczędności",
  "fin.deposit": "Wpłata",
  "fin.withdraw": "Wypłata",
  "fin.forPerson": "Dla",
  "fin.labelPlaceholder": "Opis (np. premia, przelew)",
  "fin.notePlaceholder": "Notatka (opcjonalnie)",
  "fin.recent": "Ostatnie operacje",
  "fin.noSavings": "Brak wpisów oszczędności.",
  "fin.noIncome": "Brak zapisanych dochodów.",
  "fin.incomeHistory": "Historia dochodów",
  "fin.investments": "Inwestycje i oszczędności",
  "fin.investmentValue": "Aktualna wartość",
  "fin.investmentLabel": "Konto / pozycja (np. ETF, oszczędności)",
  "fin.updateValue": "Zapisz wartość",
  "fin.investmentHistory": "Wartość w czasie",
  "fin.noInvestments": "Brak wpisów. Dodaj pierwszą wartość, aby zacząć śledzić.",
  "fin.latestValues": "Aktualne wartości",
  "fin.investmentHint": "Każdy zapis zachowuje historię, więc zobaczysz wykres w czasie.",
  ...
  "csv.sample": "Pobierz przykładowy CSV",
  "csv.titleSavings": "Import oszczędności CSV",
  "csv.helpSavings": "Kolumny: Amount, Date, Label (ujemna kwota = wypłata)",
  "csv.importedSavings": "Zaimportowano {n} wpisów",
 "csv.titleInvestments": "Import inwestycji CSV",
 "csv.helpInvestments": "Kolumny: Value, Date, Label",
 "csv.importedInvestments": "Zaimportowano {n} wpisów",
  ...
  "cats.title": "Kategorie",
  "cats.budgets": "Budżety kategorii",
  "cats.custom": "Własne kategorie",
  "lang.label": "Język",
